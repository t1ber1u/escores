 ...
 */
public class UmbrellaContentPreview extends VerticalLayout {

    private Label titleLabel = new Label("", ContentMode.HTML);

    private Label authorLabel = new Label("", ContentMode.HTML);

    private Label seriesLabel = new Label("", ContentMode.HTML);
