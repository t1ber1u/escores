...
/**
 * This class manages the lifecycle of the cs-blossom-module module. It starts and stops Spring when Magnolia starts up and
 ...
 */
public class csBlossomModule extends BlossomModuleSupport implements ModuleLifecycle {
